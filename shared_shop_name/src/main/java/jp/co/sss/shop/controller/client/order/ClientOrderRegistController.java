...
public class ClientOrderRegistController {
	...
	public String orderAddressInput(HttpSession session, Model model) {
		...
		if (session.getAttribute(bindingResultKey) != null) {
			...
			model.asMap().computeIfAbsent(bindingResultKey, k -> new org.springframework.validation.BeanPropertyBindingResult(orderForm, "orderForm"));
		}
    ...
    public String checkAddress(@Valid @ModelAttribute("orderForm") OrderForm form, BindingResult result, HttpSession session) {
